...
namespace SistemaVentas
{
    public partial class frmVentas : Form
    {
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Precio - Formato de moneda incorrecto", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtprecio.Select();
                return;
            }
            if (Convert.ToInt32(txtstock.Text) < Convert.ToInt32(txtcantidad.Value.ToString()))
            {
                MessageBox.Show("La caabtidad no debe ser mayor al stock", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debe ingresar el documento del cliente.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            {
                MessageBox.Show("Debe ingresar productos a la venta.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
